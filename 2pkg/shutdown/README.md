...
```
go get easy-go/2pkg/shutdown
```

## Documentation

`easy-go/2pkg/shutdown` documentation is available on [godoc](http://godoc.org/easy-go/2pkg/shutdown).

Both `ShutdownManagers` are also documented:
- [`PosixSignalManager`](http://godoc.org/easy-go/2pkg/shutdown/shutdownmanagers/posixsignal)
- [`AwsManager`](http://godoc.org/easy-go/2pkg/shutdown/shutdownmanagers/awsmanager)
...
import (
	...
	"easy-go/2pkg/shutdown/shutdownmanagers/awsmanager"
